"""
BaseViewSetMixin — Central error handling + perform_* hooks for Django REST Framework.

Usage:
    from .base_viewset import BaseViewSetMixin

    class MyModelViewSet(BaseViewSetMixin, viewsets.ModelViewSet):
